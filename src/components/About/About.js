	...
	return (
		<div id="about" className={classes.content}>
			<div className={isDarkTheme ? classes["main-dark"] : classes["main"]}>
				<div
					className={isDarkTheme ? classes["profile-dark"] : classes["profile"]}
				>
					<div
						className={
							isDarkTheme
								? classes["profile-dark__card"]
					...
					>
						<img
							className={
								isDarkTheme
									? classes["profile-dark__card-pic"]
									: classes["profile-card__pic"]
							}
							src={hero}
							alt="hero pic"
						/>
					...
					>
						<h2
							className={
								isDarkTheme
									? classes["profile-dark__info-title"]
									: classes["profile-info__title"]
							}
						>
							{" "}
							Hello,I'M Simret Paulos
						</h2>
						<p>
							<ReactRotatingText
								items={[
					...
					<div
						className={
							isDarkTheme
								? classes["profile-dark__social"]
								: classes["profile-social"]
						}
					>
						<a
							href="https://www.linkedin.com/in/sim-paulos-2394a5246/"
							className={
								isDarkTheme
									? classes["profile-dark__social-link"]
									: classes["profile-social__link"]
							}
						>
							<FontAwesomeIcon
								size="2x"
								icon={faLinkedin}
								className={classes["profile-social__lnkedin"]}
							/>
						</a>
						<a
							href="https://github.com/simretB05/portfolio"
							className={
								isDarkTheme
									? classes["profile-dark__social-link"]
									: classes["profile-social__link"]
						...
						>
							<FontAwesomeIcon
								size="2x"
								icon={faGithub}
								className={classes["profile-social__ghub"]}
							/>
						</a>
					</div>
				</div>
				<div className={isDarkTheme ? classes["about-dark"] : classes["about"]}>
					<div
						className={
							isDarkTheme ? classes["about-dark__card"] : classes["about-card"]
						}
					>
						<h2> About Me</h2>
						<div
