				...
				<div className={classes.main__container}>
					<div className={classes.main__container__card}>
						<h1
							className={
								isDarkTheme
									? classes.main__dark__container__card__title
									: classes.main__container__card__title
							}
						>
							{" "}
							check out my progressing skills
						</h1>
					</div>
					<div
						className={
							isDarkTheme ? classes.service__card__dark : classes.service__card
						}
					>
						<FontAwesomeIcon
							icon={faLaptop}
						...
						<div className={classes.service__card__container}>
							<h3
								className={
									isDarkTheme
										? classes.service__card__dark__container__title
										: classes.service__card__container__title
								}
							>
								Web Development
							</h3>
							<div
								className={
									isDarkTheme ? classes.skillsGrid__dark : classes.skillsGrid
								}
							>
								<img
									className={
										isDarkTheme
											? classes.skillsGrid__dark__img
											: classes.skillsGrid__img
									}
						...
						<div className={classes.service__card__container}>
							...
							>
								...
								<img
									...
									alt="The logo icon for PhotoShope"
									title="Photoshope"
								/>
							</div>
						</div>
